...
import { X, LayoutDashboard, PlusCircle, Users, Image as ImageIcon, MailWarning, Pin, Loader2 } from 'lucide-react';
    ...
    return createPortal(
        <>
            <div className="fixed inset-0 z-[150] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4" onClick={onClose}>
                <div
                    className="bg-white dark:bg-black border-2 border-black dark:border-white w-full max-w-sm p-6 relative shadow-[12px_12px_0px_0px_rgba(255,255,255,0.2)]"
